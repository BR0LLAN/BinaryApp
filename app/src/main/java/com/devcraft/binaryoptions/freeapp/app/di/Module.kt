package com.devcraft.binaryoptions.freeapp.app.di
...
val netModule = module {
    ...
    fun provideRetrofit(okHttpClient: OkHttpClient, converterFactory: Converter.Factory): Retrofit {
        return Retrofit.Builder().baseUrl(ApiConstants.API_BASE_URL).client(okHttpClient)
...
val repositoryMappersModule = module {
    fun provideGetQuotesMapper(): GetCurrencyMapper {
        return GetCurrencyMapper()
    }
